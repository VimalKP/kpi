...
/**
 * Description of login_log_mst
 *
 * @author Vimal Patel
 */
class login_log_mst_model extends CI_Model {

    var $tableName;

    function __construct() {
        parent::__construct();
        $this->tableName = "login_log_mst";
    }
    ...
    function get_record($where = array(), $limit = NULL, $offset = NULL) {
        ...
        $this->db->order_by('login_log_mst_id', 'asc');
    ...
    public function delete_record($id) {
        $this->db->where_in('login_log_mst_id', $id);
