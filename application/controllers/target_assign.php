...
//        exit();
        ...
        $limit = count($kpiarr);
        $result['assign_kpi_value'] = $this->target_model->ftech_old_target($user_id_fk, $kpiarr, $limit);
...
//        exit();
    ...
    function addtarget() {
        ...
        $select = array('kpi_id_fk' => $kpi_id_fk, 'user_id_fk' => $user_id_fk, 'DATE(target_date_added)' => date("Y-m-d"));
