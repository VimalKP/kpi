        ...
        success:function(data){
            ...
            if(count>0){
                for(var i=0;i<count;i++){
                    ...
                    var value_of_target=obj[i]['value_of_target'];
                    ...
                    if(obj[i]['kpi_type']=='boolean'){
                        ...
                        text_input='<select name="" id="kpi_'+kpi_id+'" class="form-control rounded" ><option value="true" '+trueselected+' >Yes</option><option value="false" '+falseselected+'>No</option></select>';
                    //                        $("#kpi_"+kpi_id).val(value_of_target);
                    }
                    else{
                        text_input='<input id="kpi_'+kpi_id+'" name="text" type="text" class="form-control rounded" value="'+value_of_target+'">';
                    }
